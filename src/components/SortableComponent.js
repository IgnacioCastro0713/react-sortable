...
const SortableComponent = () => {
  const [tasks, setTasks] = useState([
    {
      title: "Aprender c#",
      description: "Aprender el lenguaje c# y sus buenas practicas",
    },
    {
      title: "Aprender React",
      description: "Aprender React Js Hasta dominarlo",
    },
    {
      title: "Realizar presentación sobre c#",
      description: "Hacer power point y presentarlo",
    },
  ]);
